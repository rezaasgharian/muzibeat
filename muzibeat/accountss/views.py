...
def Post_users(request):
    ...
    return render(request, 'accountss/create_post.html')
...
class edit_post(UpdateView):
    model = Post_user
    template_name = 'accountss/update_post.html'
...
def Search_user(request, username):
    ...
    return render(request, 'accountss/search.html', context)
...
def User_Update(request):
    ...
    return render(request, 'accountss/update.html', context)
...
def Change_Password(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('accountss:change')

    else:
        form = PasswordChangeForm(request.user)
    return render(request, 'accountss/change.html', {'form': form})
