...
def histogram_bin_edges(a, bins=10, range=None, weights=None):
    ...
    bins : int or sequence of scalars or str, optional
        ...
        'fd' (Freedman Diaconis Estimator)
            ...
            accountss data variability and data size.
        ...
        'scott'
            Less robust estimator that that takes into accountss data
        ...
        'rice'
            Estimator does not take variability into accountss, only data
            size. Commonly overestimates number of bins required.

        'sturges'
            R's default method, only accountss for data size. Only
    ...
    'rice'
        ...
        does not take into accountss data variability.
    ...
    'doane'
        ...
        accountss for the skew of the data.

    'sqrt'
        .. math:: n_h = \sqrt n

        The simplest and fastest estimator. Only takes into accountss the
        data size.
